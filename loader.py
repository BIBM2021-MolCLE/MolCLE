...
def create_all_datasets():
    ...
    dataset = MoleculeDataset(root = "datasets/chembl_filtered", dataset="chembl_filtered")
    print(dataset)
    dataset = MoleculeDataset(root = "datasets/zinc_standard_agent", dataset="zinc_standard_agent")
    print(dataset)
